...
//    private bool _fileLockReleased = false;  // 标记锁是否已释放
...
//            Debug.Log($"EndLevelController: au3 进程已启动 PID={_au3Process.Id}");
//            _isProcessRunning = true;
//        }
//        catch (System.Exception e)
//        {
//            Debug.LogError($"EndLevelController: 启动进程失败 - {e.Message}");
//        }
//    }
...
//        {
//            Debug.Log($"EndLevelController: au3 进程已关闭，释放文件锁");
